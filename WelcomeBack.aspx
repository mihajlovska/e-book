<%@ Page Theme="DefaultTheme" Language="C#" AutoEventWireup="true" CodeFile="WelcomeBack.aspx.cs" Inherits="WelcomeBack" %>
...
<body>
    ...
    <p style="height: 76px; font-size: x-large;">
        ...
        <p style="height: 76px; font-size: large; margin-top:100px; margin-left:500px;">
